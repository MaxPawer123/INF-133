...
#INCISO A
ruta_get_carrera=url+"/carreras/"
get_carrera = requests.request(method="GET", url=ruta_get_carrera)
print(get_carrera.text)


#INCISO B
ruta_get_carrera=url+"economia/"
get_carrera = requests.request(method="GET", url=ruta_get_carrera)
print(get_carrera.text)
...
#POST AGREGAR 
ruta_post_economia=url+"/economias"
nuevo_estudiante = {
    "nombre": "Juanito",
    "apellido": "Pérez",
    "carrera": "Ingeniería Agronomica",
}
post_response_eco= requests.request(method="POST", url=ruta_post_economia, json=nuevo_estudiante)
