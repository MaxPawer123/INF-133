...
#Como tiene que ser el Delivery la cantidad de que compare
#No es regala requets 
...
#class DeliveryService(DeliveryVehicle):
...
#si hay mas entregas es factory