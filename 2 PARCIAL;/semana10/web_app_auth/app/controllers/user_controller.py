...
# que son decoradores que son funciones para hacer el desencriptado
...
#primero aplicamos si todas las rutas son asociadas
@user_bp.route("/users")
@login_required
def list_users():
...
# Ruta para cerrar sesión primero que tiene que ser logiado
